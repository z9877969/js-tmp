...
// Очікується
// console.log(calcBMI({wheit: 150, height: 50}));
// console.log(calcBMI({wheit: 130, height: 35}));
// console.log(calcBMI({wheit: 170, height: 85}));
...
const getBotsReport = function (companyName, repairBots, defenceBots) {
